...
These conclusions are based on 'failed' models. In order to be sure about the conclusions, i'll have to check with a setting in which a model is capable of training.
